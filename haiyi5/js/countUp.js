...
function count() {
    ...
    var e = new CountUp("countUp_num_0", 0, numTo0, 0, 4, d);
    var h = new CountUp("countUp_num_1", 0, numTo1, 0, 4, d);
    var g = new CountUp("countUp_num_2", 0, numTo2, 0, 4, d);
    var a = new CountUp("countUp_num_3", 0, numTo3, 0, 4, d);
