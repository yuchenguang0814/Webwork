...
tarteaucitron.state[service.key]=!1;tarteaucitron.userInterface.color(service.key,!1)}else if(!isResponded){isAllowed=!0;tarteaucitron.cookie.create(service.key,!0);tarteaucitron.launch[service.key]=!0;service.js();tarteaucitron.userInterface.color(service.key,!0);tarteaucitron.userInterface.openAlert()}
...
var availableLanguages='cs,en,fr,es,it,de,pt,pl,ru,tw,cn',defaultLanguage='en',lang=navigator.language||navigator.browserLanguage||navigator.systemLanguage||navigator.userLang||null;if(lang==='zh-TW'){var userLanguage='tw'}else if(lang==='zh-CN'){var userLanguage='cn'}else{var userLanguage=lang.substr(0,2)}
